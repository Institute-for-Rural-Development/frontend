...
const servicesLinks: FooterLink[] = [
  { label: "1on1 Coaching", href: "/services/coaching" },
  { label: "Company Review", href: "/services/company-review" },
  { label: "Accounts Review", href: "/services/accounts-review" },
...
const legalLinks: FooterLink[] = [
  ...
  { label: "Hiring-3 Statistics", href: "/legal/hiring-stats" },
];
    ...
    <footer>
      ...
      <div className="">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="text-teal-600">{/* Insert Logo Image */}</div>
